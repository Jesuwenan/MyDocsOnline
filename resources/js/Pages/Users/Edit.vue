                ...
                <ol class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page">Modifier un utilisateur</a>
                        </div>
                    </li>
                </ol>
            </nav>
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            this.$inertia.put(this.route('users.update',this.person.id), this.form, {
