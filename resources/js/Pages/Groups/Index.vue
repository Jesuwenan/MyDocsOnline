            ...
            <div class="px-4 sm:px-6 md:px-0">
                <div class="pb-5 sm:flex sm:items-center sm:justify-between">
                    ...
                    <div class="mt-3 sm:mt-0 sm:ml-4">
                        <inertia-link class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" :href="route('groups.create')">
                        ...
                        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            ...
                            <div class="shadow border-b border-gray-200 sm:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-200 ">
                                    ...
                                    <tbody>
                                        <!-- Odd row -->
                                        <tr v-for="group in groups.data" :key="group.id" class="bg-white">

                                            <td class="px-6 py-4 whitespace-nowrap text-left text-sm font-medium">
                                                <inertia-link class="outline-none text-indigo-600 hover:text-indigo-900"
                                                    :href="route('groups.edit', group.id)" style="display: inline">
                                                ...
                                                <button :loading="sending"
                                                    ...
                                                    style="display: inline" type="button" @click="destroy(group.id)">
...
export default {
    ...
    methods: {
        ...
        submit(id) {
            ...
            this.$inertia.post(this.route('group.addMemberToGroup', this.group_id), this.form, {
