                    ...
                    <nav class="flex-1 flex flex-col divide-y divide-gray-600 overflow-y-auto" aria-label="Sidebar">
                        ...
                        <div class="pt-6 bg-gray-600 h-full">
                            ...
                            <div class="space-y-1 space-y-1 pt-5">
                                ...
                                <inertia-link :class="isUrl('documents') ? 'bg-gray-800 text-white group flex items-center px-2 py-2 text-sm leading-6 font-medium' : 'group flex items-center px-2 py-2 text-sm leading-6 font-medium text-white hover:text-white hover:bg-gray-700'" :href="route('documents.index')">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-4 h-6 w-6 text-white" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <inertia-link :class="isUrl('document_partagés') ? 'bg-gray-800 text-white group flex items-center px-2 py-2 text-sm leading-6 font-medium' : 'group flex items-center px-2 py-2 text-sm leading-6 font-medium text-white hover:text-white hover:bg-gray-700'" :href="route('documents.view.sharedDocs')">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="mr-4 h-6 w-6 text-white" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V8l-6-6z"/><path d="M14 3v5h5M12 18v-6M9 15h6"/></svg><span v-if="!isLock">Documents Partagés</span>
                                </inertia-link>
                                ...
                                <!-- <inertia-link :class="isUrl('orders') ? 'bg-gray-800 text-white group flex items-center px-2 py-2 text-sm leading-6 font-medium' : 'group flex items-center px-2 py-2 text-sm leading-6 font-medium text-white hover:text-white hover:bg-gray-700'" :href="route('orders.index')">
                                    ...
                                    <span v-if="!isLock">Invitations</span>
                                </inertia-link> -->
